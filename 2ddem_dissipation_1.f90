module constant
    ...
    integer, parameter :: Nstep = 1000000, particle_number = 360, time_step = 1000      !time_stepは描写する時間間隔
    ...
    do step = 1, Nstep 
        if(particle_number > 0) then 
            ...
            do i = 1, particle_number   !注目する粒子
                        ...
                        do 
                            ...
                            elseif (tmp /= i) then
                                if(i < tmp) then
                                    ...
                                    if (x_center(0,step-1) > r_cylinder+deltad .and. x_center(0,step-1) < range_x -&
                                    (r_cylinder+deltad).and. step > 2000000) then 
                ...
                fwn(0:1,i), fwt(0:1,i), torque_wall(i), torque_wall2(i), u_wall, Us, slip_wall(i))

                if (x_center(0,step-1) > r_cylinder+deltad .and. x_center(0,step-1) < range_x - (r_cylinder+deltad)&
                .and. step > 2000000) then 
