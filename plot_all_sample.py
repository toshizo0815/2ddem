...
#---データの読み込み---
x, y1, y2=np.loadtxt('xt_cylinder_all.d', unpack=True)
...
ax.plot(x, y1, color="#000000", linestyle='solid', linewidth=2, marker='o', markersize=0)
ax.plot(x, y2, color="#000000", linestyle='solid', linewidth=2, marker='o', markersize=0)
# ax.plot(x, y3, color="#000000", linestyle='solid', linewidth=2, marker='o', markersize=0)
# ax.plot(x, y4, color="#000000", linestyle='solid', linewidth=2, marker='o', markersize=0)
# ax.plot(x, y5, color="#000000", linestyle='solid', linewidth=2, marker='o', markersize=0)
